...
using single_rule_1_result                = tavl::tavl_node<
    ...
    tavl::tavl_node<tavl::empty_node,
                    tavl::empty_node,
                    0,
                    pis::type_list<std::integer_sequence<char, 'a', 'b', 'c'>>,
...
using multi_rules_simple_1_result                = tavl::tavl_node<
    ...
    tavl::tavl_node<tavl::empty_node,
                    tavl::empty_node,
                    0,
                    pis::type_list<std::integer_sequence<char, 'd', 'e', 'f'>>,
                    std::integral_constant<bool, true>>>;
    ...
    tavl::tavl_node<
        ...
        tavl::tavl_node<
            tavl::tavl_node<tavl::empty_node,
                            tavl::empty_node,
                            0,
                            pis::type_list<std::integer_sequence<char, '('>>,
                            std::integral_constant<bool, true>>,
            tavl::empty_node,
            1,
            pis::type_list<std::integer_sequence<char, 'i'>>,
            std::integral_constant<bool, true>>>,
    tavl::tavl_node<
        tavl::empty_node,
        tavl::empty_node,
