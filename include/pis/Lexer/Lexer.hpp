...
namespace pis
{
    namespace Impl
    {
        ...
        template <typename N,
                  typename NFinite,
                  bool contain = tavl::tavl_contain_v<NFinite, N>>
        struct get_target_from_nfa_finite_impl
        {
            using type =
                tavl::kv_pair<typename tavl::tavl_find_t<NFinite, N>::value>;
        };
        template <typename N, typename NFinite>
        struct get_target_from_nfa_finite_impl<N, NFinite, false>
        {
            using type = tavl::empty_node;
        };
        template <typename N, typename NFinite>
        using get_target_from_nfa_finite =
            typename get_target_from_nfa_finite_impl<N, NFinite>::type;
