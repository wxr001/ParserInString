...
namespace tavl
{
    ...
    struct compare<pis::t_string<lhs...>, pis::t_string<rhs...>>
    {
        using type = std::conditional_t<
            pis::first_character_v<lhs...> >= pis::first_character_v<rhs...>,
            std::conditional_t<
                (pis::first_character_v<lhs...> >
                 pis::first_character_v<rhs...>),
                std::integral_constant<int, 1>,
                typename compare<pis::ignore_one_t<lhs...>,
                                 pis::ignore_one_t<rhs...>>::type>,
            std::integral_constant<int, -1>>;
        static constexpr int value = type::value;
    };
    template <char... rhs>
    struct compare<pis::t_string<>, pis::t_string<rhs...>>
    {
        using type                 = std::integral_constant<int, -1>;
        static constexpr int value = type::value;
    };
    template <char... lhs>
    struct compare<pis::t_string<lhs...>, pis::t_string<>>
    {
        using type                 = std::integral_constant<int, 1>;
        static constexpr int value = type::value;
    };
    template <>
    struct compare<pis::t_string<>, pis::t_string<>>
    {
        using type                 = std::integral_constant<int, 0>;
        static constexpr int value = type::value;
    };
    template <auto L, auto R>
    struct compare<pis::value_wrapper<L>, pis::value_wrapper<R>>
    {
...
namespace tavl
{
    ...
    struct compare<pis::type_pair<Arg11, Arg12>, pis::type_pair<Arg21, Arg22>>
    {
    private:
        static constexpr int comp_cur = compare_v<Arg11, Arg21>;
        using value_type              = typename std::conditional_t<
            !std::is_same_v<Arg11, Arg21>,
            identity<pis::value_wrapper<comp_cur>>,
    ...
    template <typename Arg1,
              ...
              typename Arg2,
              typename... Args2>
    struct compare<pis::type_list<Arg1, Args1...>,
                   pis::type_list<Arg2, Args2...>>
    {
    private:
        ...
        using value_type              = typename std::conditional_t<
            ...
            lazy_template<compare,
                          pis::type_list<Args1...>,
                          pis::type_list<Args2...>>>::type;

    public:
        static constexpr int value = value_type::value;
    };
    template <typename... Args2>
    struct compare<pis::type_list<>, pis::type_list<Args2...>>
    {
        static constexpr int value = -1;
    };
    template <typename... Args1>
    struct compare<pis::type_list<Args1...>, pis::type_list<>>
    {
        static constexpr int value = 1;
    };
    template <>
    struct compare<pis::type_list<>, pis::type_list<>>
    {
