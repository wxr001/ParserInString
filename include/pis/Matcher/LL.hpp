...
#include "pis/Matcher/lookahead.hpp"
...
namespace tavl
{
    ...
    struct compare<pis::ll_table_item_tmp<Arg1...>,
                   pis::ll_table_item_tmp<Arg2...>>
    {
    public:
        static constexpr int value =
            compare<pis::type_list<Arg1...>, pis::type_list<Arg2...>>::value;
    };
// for ll_table_flag
#define COMP_DEF(flag1, flag2)                         \
    template <>                                        \
    struct compare<pis::Impl::flag1, pis::Impl::flag2> \
    {                                                  \
